(function () {
    ...
    function updateActiveFilters(filters) {
        ...
        const brandLabel =
            typeof filters?.brandLabel === "string" ? filters.brandLabel.trim() : "";
    ...
    function createSorter(key) {
        return (a, b) => {
            ...
            return aValue
                .toString()
                .localeCompare(bValue.toString(), "uk", { sensitivity: "base" });
        };
    }
    ...
    function createPriceSorter(order) {
        ...
        return (a, b) => {
            ...
            const aNum = typeof aPrice === "number" ? aPrice : Number(aPrice);
            const bNum = typeof bPrice === "number" ? bPrice : Number(bPrice);
    ...
    function applyFilters() {
        ...
        if (nameQuery) {
            ...
            filtered = filtered.filter((item) => {
                ...
                const nameMatches = name != null && name.toString().toLocaleLowerCase("uk").includes(normalisedQuery);

                const articleMatches = article != null && article.toString().toLocaleLowerCase("uk").includes(normalisedQuery);
